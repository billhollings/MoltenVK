...
static void mvkInitConfig() {
	...
	MVK_SET_FROM_ENV_OR_BUILD_BOOL  (_mvkConfig.useMetalArgumentBuffers,                 MVK_CONFIG_USE_METAL_ARGUMENT_BUFFERS);
	MVK_SET_FROM_ENV_OR_BUILD_BOOL  (_mvkConfig.embedInlineBlocksInMetalArgumentBuffers, MVK_CONFIG_EMBED_INLINE_BLOCKS_IN_METAL_ARGUMENT_BUFFER);
}
